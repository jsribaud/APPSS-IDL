; $Id: //depot/Release/IDL_81/idl/idldir/lib/write_csv.pro#1 $
;
; Copyright (c) 2008-2011, ITT Visual Information Solutions. All
...
;   ITTVIS, Dec 2010:  Better handling for byte and double precision data.
;   
;-
